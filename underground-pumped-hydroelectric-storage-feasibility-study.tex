...
As prefaced above, it's important to note that these reports only examine stationary energy storage comprised of Li-ion batteries. It doesn't include pumped hydro storage. But our world's Li-ion battery capacity (about 9GW) is only a small percentage of the world's overall energy storage (160 GW). \cite{HowNewYorkCityGetsItsElectricity} The world's energy storage is almost entirely comprised of pumped hydro. But despite this market dominance, the BloombergNEF report does not even address the future of PHS growth along side the exponential growth of Li-ion batteries. Why?
