...
\begin{abstract}
Climate change poses a dire threat to humanity. We must rapidly shift to renewable energy sources like wind and solar. But doing so will require exponential growth of energy storage capacity.

In this report, we examine energy market conditions and compare energy storage technologies. We conclude that a little known technology called Underground Pumped Hydro Energy Storage could be our cheapest and most feasible option to deploy the enormous volumes of energy storage which the market will demand. We urge further research into the technology. And we also suggest immediate development of the technology on existing PHS locations where we believe it would be profitable to do so.
\end{abstract}
...
The 2018 US National Climate Assessment Report concludes that if we do not mitigate climate change, we face “substantial damages to the economy, environment, and human health over the coming decades.” \cite{NationalClimateAssessmentReport} This is not a political issue. Even if our climate change debate precludes all health and environmental factors, the projected economic costs alone are sufficient to justify urgent investments in climate change mitigation. Plain and simple, it is cheaper to deal with climate change than to ignore it.
